        ...
        try {
            ...
            if (message != null && message.getBody() != null && message.getType() == Message.Type.chat) {
                ...
                if(messageBody!=null && !messageBody.equals("")) {
                    ...
                    // check if interactive session is on for the user //then command typed must be answer to question
                    if(App.COMMAND_INTERACTIVE_SESSION.containsKey(_user)) {
                        ...
                        if (messageBody.contains("exit"))
                            //clear interactive session for user
                            App.COMMAND_INTERACTIVE_SESSION.
                         *
                         */
                    }
                    else {
