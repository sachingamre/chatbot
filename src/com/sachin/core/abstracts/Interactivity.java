...
package com.sachin.core.abstracts;
...
abstract public class Interactivity implements IDataSource {
    ...
    protected Interactivity(Command command) {
        if(!_commandQuestions.containsKey(command.pattern)) {
            ...
            _doneMessage = command.doneMessage ;
    ...
    /**
     * The function interacts with the user.
     *
     * The very first time when the user
